...
import 'package:laptop_harbor/Screens/Filter/filter.dart';
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return _buildCategoryWidget(context, index: index);
        },
      ),
    );
  }

  Widget _buildCategoryWidget(BuildContext context, {int? index}) {
